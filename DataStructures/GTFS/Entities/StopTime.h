...
public:
    ...
    {
        return (tripId < s.tripId) || ((tripId == s.tripId) && ((stopSequence < s.stopSequence) || ((stopSequence == s.stopSequence) && ((arrivalTime < s.arrivalTime) || ((arrivalTime == s.arrivalTime) && ((departureTime < s.departureTime)))))));
    }
