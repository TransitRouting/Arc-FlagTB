...
public:
    ...
    {
        return Attributes::HasAttribute(AttributeNameWrapper<ATTRIBUTE_NAME>());
    }
...
public:
    ...
    constexpr inline operator Index() const noexcept
    {
        return index;
    }

    template <AttributeNameType ATTRIBUTE_NAME>
    inline const AttributeReferenceType<ATTRIBUTE_NAME> operator[](
        const AttributeNameWrapper<ATTRIBUTE_NAME> attributeName) const noexcept
    {
        return attributes[attributeName][index];
    }
    template <AttributeNameType ATTRIBUTE_NAME>
    inline AttributeReferenceType<ATTRIBUTE_NAME> operator[](
    ...
    template <AttributeNameType ATTRIBUTE_NAME>
    inline const AttributeReferenceType<ATTRIBUTE_NAME> get(
        const AttributeNameWrapper<ATTRIBUTE_NAME> attributeName) const noexcept
    {
        return attributes[attributeName][index];
    }
