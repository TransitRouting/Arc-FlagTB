...
public:
    ...
    LineReader(const char* fileName, FILE* file)
        : file(file)
    {
    ...
    LineReader(const std::string& fileName, FILE* file)
        : file(file)
    {
    ...
    explicit LineReader(const std::vector<std::string>& fileNameAliases)
        : file(IO::openFile(fileNameAliases))
    {
...
namespace Error {
    ...
    struct WithColumnContent {
        WithColumnContent()
        {
            std::memset(columnContent, 0, MAX_COLUMN_CONTENT_LENGTH + 1);
        }
    ...
    struct IntegerMustBePositive : Base, WithFileName, WithFileLine, WithColumnName, WithColumnContent {
        ...
        {
            std::snprintf(errorMessageBuffer, sizeof(errorMessageBuffer),
                "The integer \"%s\" must be positive or 0 in column \"%s\" "
                "in file \"%s\" in line \"%d\".",
                columnContent, columnName, fileName, fileLine);
        }
    };
    ...
    struct NoDigit : Base, WithFileName, WithFileLine, WithColumnName, WithColumnContent {
        ...
        {
            std::snprintf(errorMessageBuffer, sizeof(errorMessageBuffer),
                "The integer \"%s\" contains an invalid digit in column "
                "\"%s\" in file \"%s\" in line \"%d\".",
                columnContent, columnName, fileName, fileLine);
        }
    };
    ...
    struct IntegerOverflow : Base, WithFileName, WithFileLine, WithColumnName, WithColumnContent {
        ...
        {
            std::snprintf(errorMessageBuffer, sizeof(errorMessageBuffer),
                "The integer \"%s\" overflows in column \"%s\" in file "
                "\"%s\" in line \"%d\".",
                columnContent, columnName, fileName, fileLine);
        }
    };
    ...
    struct IntegerUnderflow : Base, WithFileName, WithFileLine, WithColumnName, WithColumnContent {
        ...
        {
            std::snprintf(errorMessageBuffer, sizeof(errorMessageBuffer),
                "The integer \"%s\" underflows in column \"%s\" in file "
                "\"%s\" in line \"%d\".",
                columnContent, columnName, fileName, fileLine);
        }
    };
    ...
    struct InvalidSingleCharacter : Base, WithFileName, WithFileLine, WithColumnName, WithColumnContent {
        ...
        {
            std::snprintf(errorMessageBuffer, sizeof(errorMessageBuffer),
                "The content \"%s\" of column \"%s\" in file \"%s\" in line "
                "\"%d\" is not a single character.",
                columnContent, columnName, fileName, fileLine);
        }
    };
...
public:
    ...
    explicit CSVReader(const std::vector<std::string>& fileNameAliases)
        : in(fileNameAliases)
    {
        init();
    }
